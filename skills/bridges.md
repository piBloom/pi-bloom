...
After creating a bridge, open your Matrix client and look for the bridge bot room. Follow the bot's instructions:
...
Bridges connect external platforms to Matrix rooms. When someone messages you on WhatsApp, the bridge creates a Matrix room for that conversation. You see and reply to messages in your Matrix client. Pi can also read and respond in these rooms.
